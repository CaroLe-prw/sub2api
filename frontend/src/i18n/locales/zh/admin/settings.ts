export default {
    settings: {
      ...
      features: {
        ...
        checkIn: {
          minRecharge: '最低累计充值金额（余额单位）',
          minRechargeHint: '留空或设为 0 时无需充值。设置后，累计成功在线余额充值到账金额达到门槛即可每天签到，不会扣费；赠送余额、邀请返利、兑换码和订阅购买不计入，已退款金额不计入。',
          title: '每日签到',
          description: '通过每日随机余额奖励鼓励用户持续访问，奖励记录与余额变更会原子完成。',
          enabled: '启用每日签到',
          enabledHint: '关闭后用户端签到入口隐藏，签到接口停止发放奖励。',
          rewardMin: '单次奖励下限',
          rewardMinHint: '最小为 0.00000001，最多保留 8 位小数。',
          rewardMax: '单次奖励上限',
          rewardMaxHint: '必须大于或等于下限，最高为 100。',
        },
      },
      ...
      openaiExperimentalScheduler: {
        title: '多平台实验调度策略',
        description: '默认关闭。开启后 OpenAI、Grok、CC、Gemini 与 Antigravity 共用账号/模型健康信号；各平台仍保留自己的兼容性、额度和限流过滤规则。',
        ...
        stickyWeightedDescription: '开启后 session_hash 粘性进入多平台高级调度打分；OpenAI/Grok 还会计算 previous_response_id。关闭时仍按旧逻辑硬命中粘性账号。',
