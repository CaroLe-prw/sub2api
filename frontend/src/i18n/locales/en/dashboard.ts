export default {
  ...
  keys: {
    ...
    groupRateGuard: 'Pause when group rate exceeds a limit',
    groupRateGuardHint: 'Temporarily pauses this key above the limit and resumes it when the effective group rate falls back. Manual deactivation is unaffected.',
    maxGroupRateMultiplier: 'Maximum Group Rate',
    maxGroupRateMultiplierPlaceholder: 'For example, 0.08',
    maxGroupRateMultiplierRequired: 'Maximum group rate must be greater than 0',
    currentGroupRate: 'Current group rate: {rate}x',
    groupRateGuardCurrentlyBlocked: 'The current rate is above this limit. This key will be temporarily unavailable after saving.',
    groupRateGuardExceededList: 'Current {rate}x > limit {threshold}x',
  ...
  usage: {
    ...
    actualCost: 'Actual',
    accountCost: 'Cost',
    userRequestCost: 'User request cost',
    probeCost: 'Automatic probe cost',
