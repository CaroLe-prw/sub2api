...
export default {
  channelMonitorV2: {
    ...
    matrix: {
      title: 'Availability trend', description: 'Each row is a channel dimension; account probes automatically fill sparse real-traffic intervals', wheelZoom: 'Scroll over blocks to zoom in (narrower range, wider blocks)', wheelZoomX: 'Scroll over blocks to zoom in (narrower range, wider blocks)', dimension: 'Channel dimension', emptyTitle: 'No matrix data for the selected window', legendAria: 'Health score legend', bad: 'Bad', good: 'Good', healthyLegend: 'Healthy (≥80)', warningLegend: 'Watch (50–79)', criticalLegend: 'Critical (<50)', unknownLegend: 'No calls or account probes / insufficient samples', noTraffic: 'No availability signal in this interval', noTrafficAt: '{time} · no availability signal', scoreLine: 'Health score {score}', resetZoom: 'Reset zoom', availabilityEvidence: 'Availability evidence: {source}', availabilitySources: { probe: 'account probe (no user traffic)', mixed: 'real traffic + account probe' }
    },
    chart: {
