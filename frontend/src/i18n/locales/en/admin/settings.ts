    ...
    settings: {
      ...
      features: {
        ...
        checkIn: {
          ...
          enabledHint: 'When off, the user entry is hidden and the API stops issuing rewards.',
          rewardMin: 'Minimum reward',
          rewardMinHint: 'Minimum 0.00000001, with up to 8 decimal places.',
          rewardMax: 'Maximum reward',
          rewardMaxHint: 'Must be at least the minimum and cannot exceed 100.',
        },
      },
