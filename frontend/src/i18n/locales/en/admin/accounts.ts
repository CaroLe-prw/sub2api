export default {
    accounts: {
      ...
      upstreamBilling: {
        ...
        balanceAlertHint: 'Send a Telegram notification when the detected balance first falls below the threshold. A new drop after recovery triggers another notification.',
      ...
      newapiSync: {
        ...
        errors: {
          ...
          newapi_account_remaining_quota_invalid: 'The account remaining quota is not a safe non-negative integer.',
