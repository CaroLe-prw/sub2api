export default {
    accounts: {
      ...
      columns: {
        ...
        upstreamBillingRate: 'Scheduling Cost Rate',
        weight: 'Weight',
      ...
      upstreamBilling: {
        ...
        manualProbe: 'Refresh scheduling cost rate now',
        stale: 'Stale',
      ...
      newapiSync: {
        title: 'NewAPI upstream group ratio sync',
        description: 'Use this account’s endpoint and API key to sync the effective NewAPI user-group ratio. Scheduled runs follow the global upstream-rate detection switch and interval.',
        ...
        testSuccess: 'NewAPI connection and ratio resolution passed; the account ratio was not changed',
        testFailed: 'NewAPI connection test failed',
        syncChanged: 'NewAPI ratio synced and the account ratio was updated',
        syncUnchanged: 'Sync completed; the account ratio was already current',
        syncFailed: 'NewAPI ratio sync failed; the existing ratio was preserved',
        statuses: {
          never: 'Not synced',
          ok: 'Synced',
          failed: 'Failed'
