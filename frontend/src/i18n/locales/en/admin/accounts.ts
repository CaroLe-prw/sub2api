export default {
    accounts: {
      ...
      upstreamBilling: {
        ...
        schedulingSourceCalibrated: 'Source: upstream declaration × calibration',
        schedulingSourceFallback: 'Source: account billing rate fallback',
        ...
        newapiGroupRate: 'NewAPI effective group {group}: {value}x',
        ...
        walletBalance: 'Upstream wallet balance: {value}',
        subscriptionRemaining: 'Upstream subscription remaining: {value}',
        balanceUnavailable: 'Insufficient balance',
        balanceLow: 'Low balance: current {value}, alert threshold {threshold}',
        balanceAlert: 'Upstream low balance alert',
        balanceAlertHint: 'Enabled globally by default with a $5 threshold. Account settings can override or disable it; a new drop after recovery triggers another Telegram notification.',
        balanceAlertThreshold: 'Alert threshold',
        balanceAlertThresholdHint: 'Compared with the dollar balance returned by the upstream, independent of account billing and scheduling calibration.',
      ...
      newapiSync: {
        title: 'NewAPI upstream sync',
        description: 'Sync the NewAPI user-group ratio and raw balance quota. Scheduled runs follow the global upstream probe switch and interval.',
        enabled: 'Enable scheduled sync',
        baseUrl: 'NewAPI Base URL (optional)',
        ...
        apiKeyHint: 'Uses this account’s model API key. Only its masked state is shown here.',
        syncInterval: 'Sync interval (minutes)',
        syncIntervalHint: 'Uses the global upstream probe interval from system settings.',
        secretPlaceholder: 'Enter a new credential or keep the mask',
        secretHint: 'Credentials are encrypted. Empty values and ******** preserve the saved value.',
        secretRequiredHint: 'Required when enabling NewAPI during account creation. The credential is encrypted after the account is created.',
        createConfigRequired: 'Enter a valid NewAPI UID and user access token before creating the account.',
        initialSetupFailed: 'The account was created, but initial NewAPI setup or sync failed. Review the settings and retry in the edit dialog.',
        testConnection: 'Test connection',
        syncNow: 'Sync now',
        status: 'Last status',
        lastSyncAt: 'Last sync',
        userGroup: 'User group',
        tokenGroup: 'API key configured group',
        actualGroup: 'Actual group',
        currentRatio: 'Calibrated account rate',
        ratioSource: 'Ratio source',
        crossGroupRetry: 'Cross-group retry',
        loadFailed: 'Failed to load NewAPI sync configuration',
        saved: 'NewAPI sync configuration saved',
        saveFailed: 'Failed to save NewAPI sync configuration',
        testSuccess: 'NewAPI connection, balance, and ratio checks passed; no data was written',
        testFailed: 'NewAPI connection test failed',
        syncChanged: 'NewAPI balance synced and the account ratio was updated',
        syncUnchanged: 'NewAPI balance synced; the account ratio was already current',
        syncFailed: 'NewAPI sync failed; the existing ratio and last valid balance were preserved',
        balance: {
          title: 'Upstream balance',
          tokenName: 'API key name',
          tokenRemaining: 'API key remaining quota',
          tokenUsed: 'API key used quota',
          tokenTotal: 'API key total quota',
          tokenUnlimited: 'API key unlimited quota',
          accountRemaining: 'Account remaining quota',
          accountUsed: 'Account used quota',
          accountTotal: 'Account total quota',
        ...
        sources: {
          configured_group: 'Effective user group configuration'
        },
        errors: {
          ...
          NEWAPI_USER_ID_INVALID: 'The UID must be a positive integer.',
          newapi_base_url_invalid: 'The NewAPI Base URL or account endpoint is not allowed by the outbound security policy.',
          newapi_client_unavailable: 'The NewAPI HTTP client is unavailable.',
          newapi_configuration_incomplete: 'Enter the UID and user access token, and ensure the account itself has a model API key.',
          newapi_user_id_mismatch: 'The access token UID does not match the configured UID.',
          newapi_token_user_mismatch: 'The model API key does not belong to the configured UID.',
          newapi_token_not_enabled: 'The model API key is not enabled.',
          newapi_token_search_not_unique: 'The model API key search did not return exactly one result.',
          newapi_auto_group_unsupported: 'The API key group is auto, so its ratio cannot be resolved statically. Select a fixed group and try again.',
          newapi_effective_group_empty: 'The effective group could not be resolved.',
          newapi_effective_group_not_found: 'The effective group is missing from the user group list.',
          newapi_effective_ratio_invalid: 'The group ratio is missing or is not a finite positive number.',
          newapi_calibrated_ratio_invalid: 'The calibrated account rate is not a finite non-negative number.',
          newapi_user_self_invalid_response: 'The user response is invalid.',
          newapi_account_remaining_quota_invalid: 'The account remaining quota is not a safe integer.',
          newapi_account_used_quota_invalid: 'The account used quota is not a safe non-negative integer.',
          newapi_account_total_quota_invalid: 'The account total quota exceeds the safe integer range.',
          newapi_token_usage_invalid_response: 'The API key balance response is invalid.',
          newapi_token_remaining_quota_invalid: 'The API key remaining quota is not a safe integer; finite keys cannot report a negative value.',
          newapi_token_used_quota_invalid: 'The API key used quota is not a safe non-negative integer.',
          newapi_token_total_quota_invalid: 'The API key total quota is not a safe non-negative integer.',
          newapi_token_expires_at_invalid: 'The API key expiry value is not a safe non-negative integer.',
          newapi_token_search_invalid_response: 'The token search response is invalid.',
          newapi_user_groups_invalid_response: 'The user group response is invalid.',
          newapi_request_timeout: 'The NewAPI request timed out.',
          newapi_request_failed: 'The NewAPI request failed.',
          newapi_http_error: 'A NewAPI endpoint returned a non-success status.',
          newapi_request_build_failed: 'The NewAPI request could not be created.',
          newapi_empty_response: 'NewAPI returned an empty response.',
          newapi_response_read_failed: 'The NewAPI response could not be read.',
          newapi_response_too_large: 'The NewAPI response exceeded the size limit.',
          newapi_credential_decrypt_failed: 'The saved credential cannot be decrypted. Enter it again.',
          newapi_sync_failed: 'The NewAPI ratio synchronization failed.',
          newapi_sync_unavailable: 'The NewAPI synchronization service is unavailable.',
          newapi_identity_changed: 'The synchronization configuration changed. Try again.',
          newapi_sync_busy: 'This account is already being synchronized. Try again shortly.'
        }
      },
      ...
      quotaLimitHint: 'Set daily, weekly, and total upstream capacity limits. Capacity accounting is independent from account and scheduling cost. Changing limits or the quota multiplier does not reset usage.',
      ...
      quotaUsageMultiplier: 'Quota Usage Multiplier',
      quotaUsageMultiplierHint: 'Use 1 when upstream token cost consumes quota 1:1. This only affects account quota usage, not cost reporting or scheduling cost. Reset quota after changing it to avoid mixing units.',
      ...
      openai: {
        ...
        forceFastMode: 'Force upstream Fast mode',
        forceFastModeDesc:
          'Always forwards this account with Fast (priority). User billing still follows the original request Fast/Flex mode.',
      ...
      groupPriorityHint: 'Only affects scheduling within this group; lower values run first',
      customizeGroupPriority: 'Custom group priorities',
      followAccountPriorityShort: 'Uses {priority}',
      allGroupsFollowAccountPriority: 'All selected groups use account priority {priority}',
      billingRateMultiplier: 'Billing Rate Multiplier',
      billingRateMultiplierHint: 'Actual account cost rate and the OpenAI scheduling fallback when no declaration is usable. 0 = free.',
      expiresAt: 'Expires At',
      ...
      tokenAudit: {
        ...
        ready: 'Not run',
        unsupported: 'Available for OpenAI API key accounts using Responses API.',
        model: 'Model',
        run: 'Run audit',
        running: 'Running...',
        cancel: 'Cancel audit',
        ...
        retry: 'Retry sample',
        action: 'Action',
        failed: 'Token audit failed',
        intercept: 'Fixed input',
        fixedContextLength: 'Fixed context length',
        slope: 'Variable slope',
        completed: 'Completed',
        tokenizer: 'Tokenizer',
        variableGrowth: 'Growth',
        fixedContextStatus: 'Fixed context',
        outputCap: 'Output cap',
        englishFit: 'English fit',
        sample: 'Sample',
        local: 'Local',
        input: 'Input',
