export default {
    ...
    affiliates: {
      ...
      rebatesDescription: 'View rebates generated by payment orders, redeem codes, or manual top-ups',
      ...
      records: {
        ...
        affCode: 'Invite Code',
        order: 'Order',
        nonOrderRecharge: 'Redeem code / manual top-up',
    ...
    groups: {
      ...
      modelAllowlist: {
        ...
        batch: {
          ...
          title: 'Batch Set Model Allowlist',
          description: 'Apply the same model allowlist to the selected {count} groups.',
          enable: 'Enable model allowlist',
          models: 'Model IDs',
          ...
          success: 'Updated the model allowlist for {count} groups',
          failed: 'Failed to batch set the model allowlist'
        },
