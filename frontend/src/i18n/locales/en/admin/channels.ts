export default {
    ...
    channelMonitor: {
      ...
      dataPanel: {
        ...
        heartbeatLegend: 'Card heartbeats use 5-minute buckets: green = every expected probe succeeded, red = any failure, gray = incomplete samples.',
        aggregateStatus: { success: 'All healthy', failed: 'Failure detected', partial: 'Incomplete samples' },
