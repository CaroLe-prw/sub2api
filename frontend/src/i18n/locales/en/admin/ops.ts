export default {
    ops: {
      ...
      telegram: {
        title: 'Telegram notification template',
        description: 'Configure a reusable bot, chat, and topic delivery target.',
        enabled: 'Enable template',
        templateName: 'Template name',
        templateNamePlaceholder: 'For example, Ops alerts',
        templatesTitle: 'Telegram Templates',
        templatesDescription: 'Each template can use a different bot, chat, and forum topic, and can be reused by multiple notification types.',
        addTemplate: 'Add template',
        noTemplates: 'No Telegram templates configured.',
        unnamedTemplate: 'Unnamed template',
        routesTitle: 'Notification Routes',
        routesDescription: 'Choose a delivery template for each notification type.',
        opsAlertTemplate: 'Ops alert template',
        noTemplate: 'Do not send Telegram notifications',
        manageInSystemSettings: 'Manage template details under System Settings > Notifications.',
        upstreamRateChange: 'Upstream rate change notifications',
        upstreamRateChangeHint: 'Notify when a Sub2API probe or NewAPI sync detects a changed account rate. The first observation is not sent.',
        upstreamRateChangeTemplate: 'Rate change notification template',
        upstreamBalanceLow: 'Upstream low balance notifications',
        upstreamBalanceLowHint: 'Notify when an account first detects a balance below its threshold. No repeats are sent until the balance recovers.',
        upstreamBalanceLowTemplate: 'Low balance notification template',
        botToken: 'Bot Token',
        ...
        loadFailed: 'Failed to load Telegram notification settings',
        saveSuccess: 'Telegram notification settings saved',
        saveFailed: 'Failed to save Telegram notification settings',
        validation: {
          nameRequired: 'A Telegram template name is required',
          nameTooLong: 'Telegram template names cannot exceed 100 characters',
          tooManyTemplates: 'A maximum of 50 Telegram templates can be configured',
          ...
          rateChangeTemplateRequired: 'Select a template before enabling upstream rate change notifications',
          balanceLowTemplateRequired: 'Select a template before enabling upstream low balance notifications'
        }
      },
      settings: {
