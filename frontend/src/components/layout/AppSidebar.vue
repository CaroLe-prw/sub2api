  ...
  >
    ...
    <div class="sidebar-header" :class="{ 'sidebar-header-collapsed': sidebarCollapsed }">
      ...
      <div class="sidebar-brand" :class="{ 'sidebar-brand-collapsed': sidebarCollapsed }" :aria-hidden="sidebarCollapsed ? 'true' : 'false'">
        ...
        <!-- Version Badge -->
        <VersionBadge class="min-w-0 max-w-full" :version="siteVersion" />
      </div>
    </div>
    ...
    h(
      ...
      [
        h('path', {
          'stroke-linecap': 'round',
          'stroke-linejoin': 'round',
          d: 'M6.75 3v2.25M17.25 3v2.25M3.75 9h16.5M5.25 5.25h13.5A2.25 2.25 0 0120.25 7.5v11.25A2.25 2.25 0 0118 21H6a2.25 2.25 0 01-2.25-2.25V7.5A2.25 2.25 0 016 5.25zM8.25 14.25l2.25 2.25 4.5-4.5'
        })
      ]
    )
}
...
//
// 条目顺序：密钥 → 用量 → 可用渠道 → 渠道状态 → 订阅/支付 → 兑换/资料/签到。
...
const adminNavItems = computed((): NavItem[] => {
  const baseItems: NavItem[] = [
    ...
    { path: '/admin/scheduler-observability', label: t('nav.schedulerObservability'), icon: SignalIcon },
    ...
    { path: '/admin/quota-reset', label: t('nav.quotaReset'), icon: CogIcon, hideInSimpleMode: true },
