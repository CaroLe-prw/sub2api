      ...
      <template #table>
        ...
        >
          ...
          <template #cell-order="{ row }">
            <span v-if="row.source_type !== 'payment_order'" class="text-sm text-gray-600 dark:text-dark-300">
          ...
          <template #cell-payment_type="{ row }">
            <template v-if="row.source_type === 'payment_order' && row.payment_type">{{ t('payment.methods.' + row.payment_type, row.payment_type) }}</template>
          ...
          <template #cell-pay_amount="{ row }">
            <span v-if="row.source_type !== 'payment_order' || row.pay_amount == null" class="text-sm text-gray-400 dark:text-dark-500">-</span>
