...
func init() {
	...
	// apikeyDescMaxGroupRateMultiplier is the schema descriptor for max_group_rate_multiplier field.
	apikeyDescMaxGroupRateMultiplier := apikeyFields[5].Descriptor()
	// apikey.DefaultMaxGroupRateMultiplier holds the default value on creation for the max_group_rate_multiplier field.
	apikey.DefaultMaxGroupRateMultiplier = apikeyDescMaxGroupRateMultiplier.Default.(float64)
	...
	channelmonitorDescPublicVisible := channelmonitorFields[11].Descriptor()
	...
	// channelmonitorDescStreaming is the schema descriptor for streaming field.
	channelmonitorDescStreaming := channelmonitorFields[12].Descriptor()
	// channelmonitor.DefaultStreaming holds the default value on creation for the streaming field.
	channelmonitor.DefaultStreaming = channelmonitorDescStreaming.Default.(bool)
	...
	// groupDescOpenaiSchedulerProfile is the schema descriptor for openai_scheduler_profile field.
	groupDescOpenaiSchedulerProfile := groupFields[4].Descriptor()
	// group.DefaultOpenaiSchedulerProfile holds the default value on creation for the openai_scheduler_profile field.
	group.DefaultOpenaiSchedulerProfile = groupDescOpenaiSchedulerProfile.Default.(string)
	// group.OpenaiSchedulerProfileValidator is a validator for the "openai_scheduler_profile" field. It is called by the builders before save.
	group.OpenaiSchedulerProfileValidator = groupDescOpenaiSchedulerProfile.Validators[0].(func(string) error)
	// groupDescOpenaiSchedulerConfig is the schema descriptor for openai_scheduler_config field.
	groupDescOpenaiSchedulerConfig := groupFields[5].Descriptor()
	// group.DefaultOpenaiSchedulerConfig holds the default value on creation for the openai_scheduler_config field.
	group.DefaultOpenaiSchedulerConfig = groupDescOpenaiSchedulerConfig.Default.(domain.GroupOpenAISchedulerConfig)
