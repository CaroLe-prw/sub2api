...
var (
	...
	APIKeysColumns = []*schema.Column{
		...
		{Name: "max_group_rate_multiplier", Type: field.TypeFloat64, Default: 0, SchemaType: map[string]string{"postgres": "decimal(20,8)"}},
		...
		Indexes: []*schema.Index{
			{
				...
				Unique:  false,
				Columns: []*schema.Column{ChannelMonitorsColumns[13], ChannelMonitorsColumns[18]},
			},
			{
	...
	GroupsColumns = []*schema.Column{
		...
		{Name: "rate_multiplier", Type: field.TypeFloat64, Default: 1, SchemaType: map[string]string{"postgres": "decimal(10,4)"}},
		{Name: "max_account_cost_multiplier", Type: field.TypeFloat64, Nullable: true, SchemaType: map[string]string{"postgres": "decimal(10,4)"}},
		{Name: "openai_scheduler_profile", Type: field.TypeString, Size: 20, Default: "inherit"},
		{Name: "openai_scheduler_config", Type: field.TypeJSON, SchemaType: map[string]string{"postgres": "jsonb"}},
		...
		{Name: "model_mapping", Type: field.TypeJSON, Nullable: true, SchemaType: map[string]string{"postgres": "jsonb"}},
	...
	UsageLogsColumns = []*schema.Column{
		{Name: "id", Type: field.TypeInt64, Increment: true},
		{Name: "response_diagnostics", Type: field.TypeJSON, Nullable: true},
