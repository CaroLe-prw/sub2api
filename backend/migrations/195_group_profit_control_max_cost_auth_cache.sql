-- The absolute account-cost ceiling participates in the same request-time
-- scheduling gate as profit control. Add it to the durable auth-cache
-- invalidation trigger after migration 193 introduced the column.
...
BEGIN
    ...
    IF TG_OP = 'UPDATE'
       ...
       AND OLD.max_account_cost_multiplier IS NOT DISTINCT FROM NEW.max_account_cost_multiplier
