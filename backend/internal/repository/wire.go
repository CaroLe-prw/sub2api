...
func ProvidePricingRemoteClient(cfg *config.Config) service.PricingRemoteClient {
	return NewPricingRemoteClient(cfg.Update.ProxyURL, cfg.Security.ProxyFallback.AllowDirectOnError, cfg.Pricing.GitHubToken)
}
...
var ProviderSet = wire.NewSet(
	...
	NewOpsRepository,
	NewOpenAISchedulerObservabilityRepository,
