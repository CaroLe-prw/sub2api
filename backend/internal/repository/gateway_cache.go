...
func (c *gatewayCache) SaveLiveCall(ctx context.Context, record *service.LiveCallRecord, ttl time.Duration) error {
	...
	values := map[string]any{
		...
		"group_mapped":         record.GroupMapped,
		"channel_id":           record.ChannelID,
		"original_model":       record.OriginalModel,
		"channel_mapped_model": record.ChannelMappedModel,
		"billing_model_source": record.BillingModelSource,
		"model_mapping_chain":  record.ModelMappingChain,
...
func (c *gatewayCache) GetLiveCall(ctx context.Context, callHash string) (*service.LiveCallRecord, error) {
	...
	return &service.LiveCallRecord{
		...
		ChannelUsageFields: service.ChannelUsageFields{
			GroupMapped:        values["group_mapped"] == "1" || values["group_mapped"] == "true",
			ChannelID:          parseInt("channel_id"),
			OriginalModel:      values["original_model"],
			ChannelMappedModel: values["channel_mapped_model"],
			BillingModelSource: values["billing_model_source"],
			ModelMappingChain:  values["model_mapping_chain"],
		},
		CreatedAt:             createdAt,
		ExpiresAt:             expiresAt,
