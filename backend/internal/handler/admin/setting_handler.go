...
func (h *SettingHandler) GetSettings(c *gin.Context) {
	...
	payload := dto.SystemSettings{
		...
		VaptchaKeyConfigured:                                   settings.VaptchaKeyConfigured,
		...
		OpenAISchedulerObservabilityEnabled:                    settings.OpenAISchedulerObservabilityEnabled,
		OpenAISchedulerObservabilityMaxTraces:                  settings.OpenAISchedulerObservabilityMaxTraces,
		OpenAISchedulerObservabilityRetentionDays:              settings.OpenAISchedulerObservabilityRetentionDays,
		...
		CheckInMinRecharge: settings.CheckInMinRecharge,
