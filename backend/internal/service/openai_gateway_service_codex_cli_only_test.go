...
func TestOpenAIGatewayService_Forward_OAuthModelCapacityErrorAllowsRetryWhenSelectionIsExhausted(t *testing.T) {
	gin.SetMode(gin.TestMode)
	...
	require.False(t, c.Writer.Written(), "service 层应把 OAuth 容量错误交给上层选择循环")
}
