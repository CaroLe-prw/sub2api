...
func cloneGroupForDuplicate(source *Group, operationID string) *Group {
	return &Group{
		...
		MaxAccountCostMultiplier:        cloneGroupValuePointer(source.MaxAccountCostMultiplier),
		OpenAISchedulerProfile:          source.OpenAISchedulerProfile,
		OpenAISchedulerConfig:           source.OpenAISchedulerConfig,
