...
func (s *BillingService) initFallbackPricing() {
	...
	s.fallbackPrices["gpt-5.6-terra"] = &ModelPricing{
		...
		InputPricePerTokenPriority:         6.25e-6,
		OutputPricePerToken:                15e-6,
		OutputPricePerTokenPriority:        37.5e-6,
		CacheCreationPricePerToken:         3.125e-6,
		CacheCreationPricePerTokenPriority: 7.8125e-6,
		CacheReadPricePerToken:             0.25e-6,
		CacheReadPricePerTokenPriority:     0.625e-6,
		LongContextInputThreshold:          openAIGPT54LongContextInputThreshold,
		LongContextInputMultiplier:         openAIGPT54LongContextInputMultiplier,
		LongContextOutputMultiplier:        openAIGPT54LongContextOutputMultiplier,
	}
	s.fallbackPrices["gpt-5.6-luna"] = &ModelPricing{
		...
		OutputPricePerTokenPriority:        15e-6,
		CacheCreationPricePerToken:         1.25e-6,
		CacheCreationPricePerTokenPriority: 3.125e-6,
