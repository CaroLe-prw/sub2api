...
func (s *adminServiceImpl) BulkUpdateAccounts(ctx context.Context, input *BulkUpdateAccountsInput) (*BulkUpdateAccountsResult, error) {
	...
	if len(input.Credentials) > 0 || input.ProxyID != nil || needMixedChannelCheck || openAISettings.any() || hasForceFastModeUpdate || hasUpstreamRateCalibrationUpdate || hasUpstreamBalanceAlertEnabledUpdate || hasUpstreamBalanceAlertThresholdUpdate || input.ProbeEnabled != nil || input.RateMultiplier != nil {
