...
func ProvideAuthService(
	...
	svc.vaptchaService = vaptchaService
	return svc
}
...
func ProvideScheduledTestService(
	...
	if repo, ok := usageLogRepo.(schedulerUserTrafficRepository); ok {
		svc.SetSchedulerUserTrafficRepository(repo)
	}
	return svc
}
...
func ProvideOpenAIGatewayService(
	...
	settingService *SettingService,
	userPlatformQuotaRepo UserPlatformQuotaRepository,
	observabilityRepo OpenAISchedulerObservabilityRepository,
) *OpenAIGatewayService {
	...
	svc.AttachOpenAISchedulerObservabilityPersistence(NewOpenAISchedulerObservabilityPersistence(observabilityRepo))
	return svc
}
