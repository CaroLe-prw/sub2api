...
func TestOpenAISchedulerCanonicalResetScoresMatchSnapshot(t *testing.T) {
	...
	snapshots := buildOpenAIAccountSchedulerScoreSnapshot(accounts, nil, scheduler.service.openAIWSSchedulerWeights(), false, floatPtr(defaultOpenAIOAuthSchedulingRateMultiplier), nil)
