		...
		},
		{
			...
			wantJSON: `{
				...
				"data": {
					...
					"openai_advanced_scheduler_effective_lb_top_k": "4",
					"openai_advanced_scheduler_effective_weight_priority": "0.5",
					"openai_advanced_scheduler_effective_weight_load": "1.5",
					"openai_advanced_scheduler_effective_weight_queue": "1.5",
					"openai_advanced_scheduler_effective_weight_error_rate": "4",
					"openai_advanced_scheduler_effective_weight_ttft": "2.5",
					"openai_advanced_scheduler_effective_weight_reset": "0.2",
					"openai_advanced_scheduler_effective_weight_quota_headroom": "0.8",
					"openai_advanced_scheduler_effective_weight_upstream_cost": "1.5",
					"openai_advanced_scheduler_effective_weight_previous_response": "0.3",
					"openai_advanced_scheduler_effective_weight_session_sticky": "0.1",
